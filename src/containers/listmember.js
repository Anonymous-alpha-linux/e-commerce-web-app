...
import { ButtonComponent, ContainerComponent, Form, Icon, ListMember, Preview, Text } from '../components'
import { FaSearch } from 'react-icons/fa';

export default function ListMemberContainer() {
  return (
    <ListMember style ={{width: '100%'}}>
                ...
                <ContainerComponent.Flex>
                    <ContainerComponent.Item>
                        <ContainerComponent.Flex style={{ height: "50px", alignItems: "center" }}>
                            {/* <ContainerComponent.Item style={{ padding: "0", height: "fit-content" }}>
                            ...
                            <ContainerComponent.Item>
                                <Text.Subtitle style={{ textAlign: "start", margin: 0 }}>Name</Text.Subtitle>
                            </ContainerComponent.Item>
                        </ContainerComponent.Flex>
                        <ContainerComponent.Flex style={{ height: "50px", alignItems: "center" }}>
