...
AnimateComponent.SlideRight = function AnimatedSlideRight({ children, state, ...props }) {
  ...
  return <>
    {transition((style, state) => { return state ? <animated.div style={style} {...props}>{children}</animated.div> : "" })}
  </>
}